...
class AppStyle {
  static TextStyle txtInterRegular15Gray600 = TextStyle(
  ...
  static TextStyle txtPlusJakartaSansRomanMedium14 = TextStyle(
  ...
  static TextStyle txtNetflixSansMedium12 = TextStyle(
  ...
  static TextStyle txtNetflixSansMedium32 = TextStyle(
  ...
  static TextStyle txtNetflixSansMedium16 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtInterRegular12Black900 = TextStyle(
  ...
  static TextStyle txtNetflixSansMedium14 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtNetflixSansMedium13 = TextStyle(
    color: ColorConstant.gray2004c,
    fontSize: getFontSize(
      13,
    ),
    fontFamily: 'Netflix Sans',
  ...
  static TextStyle txtInterRegular7 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      7,
    ),
  ...
  static TextStyle txtInterLight12 = TextStyle(
  ...
  static TextStyle txtPlusJakartaSansRomanMedium8 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      8,
    ),
  ...
  static TextStyle txtInterSemiBold11 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      11,
    ),
  ...
  static TextStyle txtNetflixSansRegular20 = TextStyle(
    color: ColorConstant.gray50B2,
    fontSize: getFontSize(
      20,
    ),
    fontFamily: 'Netflix Sans',
  ...
  static TextStyle txtInterLight10Gray60001 = TextStyle(
    color: ColorConstant.gray60001,
    fontSize: getFontSize(
      10,
    ),
  ...
  static TextStyle txtInterSemiBold25 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      25,
    ),
  ...
  static TextStyle txtNetflixSansRegular12 = TextStyle(
  ...
  static TextStyle txtNetflixSansRegular10 = TextStyle(
    color: ColorConstant.whiteA70090,
    fontSize: getFontSize(
      10,
    ),
  ...
  static TextStyle txtInterRegular12WhiteA7001 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      12,
    ),
